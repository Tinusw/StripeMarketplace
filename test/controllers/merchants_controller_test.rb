...
class MerchantsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create merchant" do
    assert_difference('Merchant.count') do
      post merchants_url, params: { merchant: { description: @merchant.description, title: @merchant.title, user_id: @merchant.user_id } }
    end
  ...
  test "should update merchant" do
    patch merchant_url(@merchant), params: { merchant: { description: @merchant.description, title: @merchant.title, user_id: @merchant.user_id } }
